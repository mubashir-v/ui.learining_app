...
function CourseCard() {
  return (
    <div className="flex h-72 md:h-96 w-1/2 md:w-1/3 lg:w-1/5 items-center justify-center p-2 ">
      <Link
        to={"/course/course-slug"}
        className="h-full w-full border rounded-lg shadow-lg bg-white  overflow-hidden hover:shadow-lg hover:shadow-black"
      >
        <div className="flex flex-col h-full w-full ">
          {/* Top Section */}
          <div className="w-full h-2/4 bg-slate-50 p-4 ">
